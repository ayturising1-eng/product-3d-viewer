  ...
  class P3DVPdf {
    ...
    text(value, x, y) {
      ...
      lines.forEach((line, index) => {
        ...
        const yPt = (this.pageHeight - ((Number(y) || 0) + index * lineStepMm)) * MM_TO_PT;
        this.currentPage.commands.push(
          `${colorCommand(this.textColor, false)} BT /${fontRef} ${this.fontSize.toFixed(2)} Tf ${xPt.toFixed(2)} ${yPt.toFixed(2)} Td (${escapePdfText(line)}) Tj ET`
        );
      });
      return this;
    }
    ...
    rect(x, y, width, height, style) {
      ...
      this.currentPage.commands.push(`${colorCommand(this.drawColor, true)} ${colorCommand(this.fillColor, false)} ${xPt.toFixed(2)} ${yPt.toFixed(2)} ${wPt.toFixed(2)} ${hPt.toFixed(2)} re ${paint}`);
      return this;
    }
    ...
    line(x1, y1, x2, y2) {
      ...
      this.currentPage.commands.push(`${colorCommand(this.drawColor, true)} ${startX.toFixed(2)} ${startY.toFixed(2)} m ${endX.toFixed(2)} ${endY.toFixed(2)} l S`);
      return this;
    }
