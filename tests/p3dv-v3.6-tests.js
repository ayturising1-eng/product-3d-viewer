...
for (const token of [
  'p3dv.v3.6', 'Freedom Giriş Bilgileri', 'Bioclimatic', 'B-Cube', 'Family', 'Modül 1',
  'placeholder="Maks. 4050 mm"', 'placeholder="Maks. 7060 mm"', 'placeholder="Maks. 30 adet"', 'Paneller Açık', 'toolboxPanelMasterInput', 'Sabit Doğrama',
